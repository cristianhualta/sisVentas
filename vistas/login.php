...
<html>
  ...
  <body class="hold-transition login-page" style="background-image: url(../files/fondo.jpg); background-size: 100% 100%; background-attachment: fixed;">
    <div class="login-box">
      <div class="login-logo">
        <a><h1>TU NEGOCIO <i class="fa fa-shopping-cart"></i></h1></a>
      </div><!-- /.login-logo -->
      <div class="loginBox">
