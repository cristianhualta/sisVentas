<?php
//Referencia a la clase fpdf.php
...
function addSociete2($adresse,$logo,$ext_logo )
{
	$x1 = 20;
	$y1 = 122;
	//Positionnement en bas
	$this->Image($logo , 105 ,120, 15 , 15 , $ext_logo);
...
// Client address
function addClientAdresse( $cliente,$legajo,$domicilio,$num_documento)
{
	$r1     = $this->w - 201;
	$r2     = $r1 + 68;
	$y1     = 40;
	...
	$this->SetXY( $r1+14, $y1-3);
	$this->SetFont( "Arial", "", 10);
	$this->MultiCell( 152, 4, $cliente);
	$this->SetXY( $r1, $y1+2);
	$this->MultiCell( 152, 4, $legajo);
	$this->SetXY( $r1, $y1+7);
